...
<body class="w100">
								...
								<li class="section-main" onclick="getVideo(${video.id})">
									...
									<div class="classify-v-info">
										<span class="count" title="观看次数"> <img
											...
											alt="">${video.videoPlayTimes }</span> <span class="duration"
											title="视频时长"> <img
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='${pageContext.request.contextPath }/visitor/showvideo/videoindex.action?videoId='+id+'&subjectId='+subjectId;
		}
	</script>

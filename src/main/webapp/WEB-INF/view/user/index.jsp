	...
	<div class="container">
		...
		<div id="profile_tab">
			<ul class="profile_tab_header f_left clearfix">
				<li><a href="${pageContext.request.contextPath }/user/profile.action">更改资料</a></li>
				<li class="profile_tab_line">|</li>
				<li><a href="${pageContext.request.contextPath }/user/avatar.action">更改头像</a></li>
				<li class="profile_tab_line">|</li>
				<li><a href="${pageContext.request.contextPath }/user/password.action">密码安全</a></li>
			</ul>
				...
				<div class="proflle_tab_workplace clearfix">
					<div class="profile_avatar_area">
						<c:if test="${empty user.headUrl}">
							<img id="avatar" src="${pageContext.request.contextPath }/img/avatar_lg.png" alt="这是什么">
						</c:if>
					...
					<ul class="profile_ifo_area">
						...
						<li><span class="dd">性&#x3000;别：</span> <c:if
								test="${user.sex==2}">
                                    		女
						...
						<fmt:formatDate value="${user.birthday}" pattern="YYYY-MM-dd"></fmt:formatDate></li>

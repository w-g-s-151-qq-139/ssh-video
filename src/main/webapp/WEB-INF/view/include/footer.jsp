		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="${pageContext.request.contextPath }/img/微信公众号.png" alt="111" draggable="false">
						<img class="weibo" src="${pageContext.request.contextPath }/img/微博公众号.png" alt="222" draggable="false">
					</div>
				</li>
			</ul>
		</li>
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm" action="front/user/login.do" method="post">
				...
				<div id="forget">
					<a href="${pageContext.request.contextPath }/visitor1/forget_pwd.action">忘记密码？</a>
				</div>

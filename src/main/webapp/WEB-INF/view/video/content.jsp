		...
		<div class="v-intro">
			...
			<div class="right">
				...
				<div class="avatar">
					...
					<p>
						<b>讲师：${speaker.speakerName}</b><br> <i>${speaker.speakerDescr}</i>
					</p>
				</div>
				<p class="video-intro">
	...
	<div class="container">
		...
		<c:forEach items="${videolist}" var="video" varStatus="status">
			...
			<div class="chapter">
				<p class="biaoti">
					<a
						href="${pageContext.request.contextPath }/visitor/showvideo/videoindex.action?videoId=${video.id}&subjectId=${video.course.subject.id}">${video.videoTitle}</a>
				</p>
				<p class="lecturer">${video.videoDescr}</p>
				<p class="lecturer">
					讲师：
					<c:forEach items="${speakerlist}" var="sp">
						${video.speaker.id==sp.id?sp.speakerName:""}
					</c:forEach>
				</p>
				<div class="v-info">
					<span class="count"><img
						src="${pageContext.request.contextPath }/img/count.png" alt="">${video.videoPlayTimes}</span>
					<span class="duration"><img
